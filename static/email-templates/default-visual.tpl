            ...
            <td>
              ...
              <div style="font-weight:normal;padding:16px 24px 16px 24px">
                ...
                <p>
                  ...
                  <a href="https://github.com/appzenowebservices/Omnipost/docs" target="_blank">documentation</a>.
                </p>
              </div>
              ...
              <div style="padding:16px 24px 16px 24px">
                <a href="https://github.com/appzenowebservices/Omnipost"
                  style="color:#FFFFFF;font-size:16px;font-weight:bold;background-color:#4F46E5;border-radius:4px;display:inline-block;padding:12px 20px;text-decoration:none"
                  target="_blank">
