...
Cypress.Commands.add('resetDB', () => {
  ...
  // from within it, patra is killed, the DB reset, and run again
  // in the background. If the DB is reset without restarting patra,
...
Cypress.Commands.add('loginAndVisit', (url) => {
  ...
  const username = Cypress.env('PATRA_ADMIN_USER') || 'admin';
  const password = Cypress.env('PATRA_ADMIN_PASSWORD') || 'patra';
