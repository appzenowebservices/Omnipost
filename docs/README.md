...
This repository contains the source for the static website https://github.com/appzenowebservices/Omnipost
...
- `i18n` directory has the static UI for i18n translations: https://github.com/appzenowebservices/Omnipost/i18n
