...
import (
	...
	"github.com/appzenowebservices/patra/internal/migrations"
...
func checkUpgrade(db *sqlx.DB) {
	...
	lo.Fatalf(`there are %d pending database upgrade(s): %v. The last upgrade was %s. Backup the database and run patra --upgrade`,
