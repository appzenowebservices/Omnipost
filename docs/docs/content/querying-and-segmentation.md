...
patra allows the writing of partial Postgres SQL expressions to query, filter, and segment subscribers.
...
![patra screenshot](images/edit-subscriber.png)

## Sample SQL query expressions

![patra](images/query-subscribers.png)
